 ...
 *Last Edit:Mar 24 2017
 *Program Name:Ten Average
 */
...
public class TenAverage {
	...
	public static void main(String[] args) {
		...
		count = input.nextInt();
// changed average evaluation up to 10
		runningCount = count;
		total = 0;
		...
		//added if statements for running counts 6-10
		if (runningCount == 5) {
			System.out.print("Please enter " + (count - runningCount) + " number: ");
			total += input.nextInt();
			runningCount--;
...
// set running counts to -- and total to += input.nextInt()
		if (count > 0)
